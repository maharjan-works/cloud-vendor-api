...
class CloudVendorControllerTest {
    ...
    @BeforeEach
    void setUp() {
        cloudVendorOne = new CloudVendor("100","Amazon","Amazon address", "XXXX");
        cloudVendorTwo = new CloudVendor("200","Target","Target address", "XXXX");
    ...
    void testGetCloudVendorDetails() throws Exception {
        when(cloudVendorService.getCloudVendor("100")).thenReturn(cloudVendorOne);
        this.mockMvc.perform(get("/cloudvendor/100"))
    ...
    void testDeleteCloudVendorDetails() throws Exception {
        when(cloudVendorService.deleteCloudVendor("100")).thenReturn("Success");
        this.mockMvc.perform(delete("/cloudvendor/100"))
                .andDo(print()).andExpect(status().isOk());
    }
}